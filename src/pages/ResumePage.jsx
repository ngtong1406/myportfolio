...
const ResumePage = () => {
    ...
    return (
        ...
        >
            ...
            <div
                id="rmFadeIn"
                className="max-sm:flex-col flex flex-wrap items-center justify-center gap-3 max-sm:space-y-4 font-inria-serif"
            >
                ...
                <a
                    ...
                    href={resume}
                    target="_blank"
                    className="scroll-mt-40 inline-flex items-center gap-2 text-black py-1.5 px-5 bg-transparent border border-black hover:bg-black hover:underline hover:underline-offset-3 hover:text-white hover:cursor-pointer focus-within:outline-0 duration-50"
                    draggable={false}
                >
                    ...
                    <svg
                        ...
                        viewBox="0 0 24 24"
                    >
                        <title>open-in-new-tab-outline</title>
